...
const AgentManagementScreen = ({ navigation, route }) => {
  ...
  if (route?.params?.backScreen === "SupervisorDashboard") {
  ...
  navigation.navigate("Main", { screen: "SupervisorDashboard" });
};
  ...
  try {
    ...
    navigation.navigate(screenName, {
      ...
      fromSuperAdmin,
      backScreen: fromSuperAdmin ? "SuperAdminDashboard" : "ManageAgents",
    });
  } catch (error) {
