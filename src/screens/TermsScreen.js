    ...
    >
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          ...
          these Terms and Conditions. Continued use of the platform constitutes
          acceptance of all applicable rules and policies.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          ...
          carried out through your account shall be considered authorized by the
          account owner.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          ...
          carefully reviewed before confirmation. Successfully completed digital
          transactions are generally non-refundable except where service failure
          is verified by Bellaj Data Hub.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          ...
          issues, banking disruptions, or events beyond our reasonable control.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          Users must not engage in fraudulent transactions, unauthorized access
          attempts, identity theft, money laundering, abuse of promotional
          offers, or any activity that violates applicable laws and regulations.
        </Text>
      </View>
